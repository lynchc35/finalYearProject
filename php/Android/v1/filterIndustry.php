...
//filterLocation.php
    ...
    //creating a query
    $stmt = $conn->prepare("SELECT a.jobListingID, a.roleTitle, a.organisationID, a.location, a.roleRequirements, a.roleDuties, a.salary, a.listingStatus, b.orgName, b.industry FROM jobListing a, organisations b WHERE a.organisationID = b.organisationID AND b.industry = '$id';");
