...
public class JobListingsModel implements Serializable {
    ...
    public JobListingsModel(int jobListingID, String roleTitle, int organisationID, String location, String roleRequirements, String roleDuties, String salary, String listingStatus, String orgName) {
