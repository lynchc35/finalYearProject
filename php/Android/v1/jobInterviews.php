...
//orgInterviews.php
	...
	//creating a query
	$stmt = $conn->prepare("SELECT a.interviewID, a.outcome, a.location, a.time, a.additional, a.feedback, b.fName, b.lName, b.applicantID, c.roleTitle, d.applicationID, c.jobListingID FROM interviews a, applicants b, jobListing c, application d WHERE d.applicantID = b.applicantID AND d.jobListingID = c.jobListingID AND a.applicationID = d.applicationID AND c.jobListingID = '$id';");
