...
public class InterviewTips extends AppCompatActivity {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.profile:
                        Intent intent3 = new Intent(InterviewTips.this, ApplicantProfile.class);
                        startActivity(intent3);
                        return true;
                    case R.id.jobs:
                        Intent intent = new Intent(InterviewTips.this, JobListings.class);
                    ...
                    case R.id.applications:
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_APP_PER_USER, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (apps.isNull(0)) {
                                        ...
                                        Intent intent = new Intent(InterviewTips.this, applicantApplications.class);
                                        startActivity(intent);
                                    }
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(InterviewTips.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }) {
                            @Override
                    ...
                    case R.id.interviews:
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (apps.isNull(0)) {
                                        ...
                                        Intent intent = new Intent(InterviewTips.this, ApplicantInterviews.class);
                                        startActivity(intent);
                                    }
                        ...
                        return true;
                    case R.id.advice:
                        Intent intent5 = new Intent(InterviewTips.this, Advice.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(InterviewTips.this, Advice.class);
        startActivity(intent);
